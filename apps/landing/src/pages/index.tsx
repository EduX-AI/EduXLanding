...
const downloadEntries = {
	...
	macOS: {
		...
		icon: <Apple />,
		links: {
			'University': 'eduxgpt.streamlit.app/',
			'High School': 'eduxgpt-highschool.streamlit.app/'
		}
	},
	windows: {
		name: 'Windows',
...
const platforms = [
{ name: 'macOS', icon: Apple, clickable: true, version: '' },
{
name: 'Windows',
icon: WindowsLogo,
...
{ name: 'Android', icon: AndroidLogo, version: '' },
{ name: 'Web', icon: Globe }
] as const;
	...
	return (
		<TooltipProvider>
			<Head>
				...
				<meta
					name="description"
					content="Degree Scheduling Using AI. Degree Scheduling Explorer Designed for High School and University Students."
				/>
				<meta
					property="og:image"
				...
				<meta
					name="keywords"
					content="AI, OpenAI, Higher Education, EduX, Edu, University, Degree"
				/>
			...
			<PageWrapper>
				...
				<div className="flex w-full flex-col items-center px-4">
					...
					<NewBanner
						headline="EduX Alpha release is finally here!"
						href="/blog/october-alpha-release"
// /blog/october-alpha-release
						link="Read post"
					...
					<p className="animation-delay-1 fade-in-heading text-md leading-2 z-30 mb-8 mt-1 max-w-4xl text-center text-gray-450 lg:text-lg lg:leading-8">
						 Degree scheduling explorer, unifying higher education in the United States. 
						<br />
					...
					<div className="flex flex-row gap-3">
						...
						<a target="_blank" href="https://www.github.com/AhmedIbreljic">
							<HomeCTA
								icon={<Github />}
								className="z-5 relative"
								text="Star on GitHub"
